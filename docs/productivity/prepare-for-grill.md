...
The report tests three things: whether two readers would understand the same assignment, whether one design tree can converge in a session, and whether every supplied source is assessable, relevant, and consistent with the prompt.
