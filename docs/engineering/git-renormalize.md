...
```bash
npx skills add Nulfrog/skills --skill=git-renormalize
```

```bash
npx skills update git-renormalize
```

[Source](https://github.com/Nulfrog/skills/tree/main/skills/engineering/git-renormalize)
...
Reach for it when status and diff disagree because of line endings. For deliberate staging and committing after the tree is clean, use [git-commit](https://aihero.dev/skills-git-commit).
