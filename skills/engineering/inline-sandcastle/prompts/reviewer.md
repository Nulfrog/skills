...
Task under review: {{ISSUE}}

## CONTEXT

Read the change before reviewing:

- `git diff main...{{BRANCH}}` — the change under review
- `git log main..{{BRANCH}} --oneline` — commits on this branch
...
5. **Apply project standards**: Read and follow the coding standards in
...
3. Commit with a message starting with `RALPH: Review -`

If the code is already clean and well-structured, do nothing.

## COMPLETION

Return a short summary of what you changed (or "no changes — already clean"). End
