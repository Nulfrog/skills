...
- **[decision-review](./decision-review/SKILL.md)**: Two-axis review of a decision a session just changed: **Coherence** (does it agree with the ADRs and `CONTEXT.md` already in the repo?) and **Conformance** (where does the codebase diverge from it?), run as parallel sub-agents. Fixes the docs and the code that mechanically drifted from them; specifies the rest.
