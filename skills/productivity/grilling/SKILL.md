...
When a question's options are hard to compare in the abstract, give a pseudo-breakdown: pseudocode or a worked example of each option over one tiny shared case.
When a question uses technical terms I may not know, define them in a short terminology table.
